...
<header class="sticky h-20 w-full h-18 bg-yellow-50 shadow-lg px-4 md:px-12 top-0 flex-shrink-0">
    <div class="flex m-auto flex-wrap items-center justify-between p-3 mx-auto bg-yellow-50">
