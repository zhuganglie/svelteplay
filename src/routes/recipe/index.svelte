...
<h3>随机菜单</h3>
<button on:click={dish} class=" px-1.5 py-0.5 mb-2 text-green-50 bg-green-900 rounded ">点我更新</button>
<ul>
  {#each menu as item}
...
<h3>自选菜单</h3>
<button on:click={vis} class=" px-1.5 py-0.5 mb-8 text-green-50 bg-green-900 rounded ">点我选择</button>
